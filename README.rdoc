...
A simple jQuery plugin to create a tree map view of json data. View a {live sample}[http://htmlpreview.github.io/?https://github.com/colinbate/jquery-treemap/blob/master/index.html]
